...
const Invoice = () => {
    ...
    return (
        <div className="min-h-screen bg-[#85C79A] py-24 px-4 relative overflow-hidden">
            ...
            {/* Invoice Document */}
            <div className="max-w-4xl mx-auto bg-[#85C79A] text-white p-12 md:p-24 shadow-2xl rounded-[3rem] border border-white/5 relative overflow-hidden print:shadow-none print:p-0 print:bg-white print:text-black">
