    ...
    return (
        <div className="min-h-screen bg-[#7FB77E] py-24 px-4 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto mb-12 flex items-center justify-between print:hidden">
                ...
                <button 
                    onClick={handlePrint}
                    className="flex items-center gap-4 px-10 py-5 bg-[#0B2D72] text-white rounded-2xl font-black uppercase text-[10px] tracking-[0.4em] hover:bg-[#7FB77E] transition-all shadow-xl shadow-[#0B2D72]/10 active:scale-95"
                >
                    <Printer size={16} />
                    Print Settlement
                </button>
            ...
            {/* Invoice Document */}
            <div className="max-w-4xl mx-auto bg-[#7FB77E] text-white p-12 md:p-24 shadow-2xl rounded-[3rem] border border-white/5 relative overflow-hidden print:shadow-none print:p-0 print:bg-[#7FB77E] print:text-black">
