...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center bg-[#85C79A] pt-32 pb-16 px-4">
      <div className="max-w-md w-full space-y-8 bg-white shadow-2xl p-10 rounded-xl">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs font-black text-gray-900 uppercase tracking-widest ml-1 mb-2 block">New Password</label>
              <input
                type="password"
                required
                minLength="6"
            ...
            <div>
              <label className="text-xs font-black text-gray-900 uppercase tracking-widest ml-1 mb-2 block">Confirm Password</label>
              <input
                type="password"
                required
                className="w-full border border-gray-200 p-4 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#85C79A] text-gray-900 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#85C79A] transition-all disabled:opacity-50 shadow-lg mt-4"
          >
