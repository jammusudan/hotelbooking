      ...
      <div className="max-w-md w-full space-y-8 bg-white shadow-2xl p-10 rounded-xl">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#FAACBF] text-gray-900 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#FAACBF] transition-all disabled:opacity-50 shadow-lg mt-4"
          >
