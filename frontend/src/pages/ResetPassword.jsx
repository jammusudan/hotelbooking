      ...
      <div className="max-w-md w-full space-y-8 bg-white shadow-2xl p-10 rounded-xl">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs font-black text-[#281C59] uppercase tracking-widest ml-1 mb-2 block">New Password</label>
              <input
                type="password"
                required
                minLength="6"
            ...
            <div>
              <label className="text-xs font-black text-[#281C59] uppercase tracking-widest ml-1 mb-2 block">Confirm Password</label>
              <input
                type="password"
                required
                className="w-full border border-gray-200 p-4 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#EDF7BD] text-[#281C59] py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#EDF7BD] transition-all disabled:opacity-50 shadow-lg mt-4"
          >
