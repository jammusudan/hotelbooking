    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-3 bg-[#0B2D72] text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white hover:text-black transition-all shadow-lg shadow-[#0B2D72]/20 active:scale-95 group disabled:opacity-30"
        >
            ...
            <div key={room._id} className="bg-[#111114] rounded-[2.5rem] p-8 border border-gray-800/50 hover:border-[#0B2D72]/30 transition-all group relative flex flex-col shadow-2xl">
              <div className="flex justify-between items-start mb-8 pb-6 border-b border-gray-800/50">
                ...
                <div className="flex gap-4">
                  <button 
                    ...
                    className="p-3 bg-[#0AC4E0] text-white hover:text-white hover:bg-gray-800 rounded-xl transition-all border border-gray-800"
                  >
              ...
              <div className="flex flex-wrap gap-2.5 mt-auto">
                {room.amenities.map(a => (
                  <span key={a} className="bg-[#0AC4E0]/50 text-white px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest border border-gray-800 group-hover:border-[#0B2D72]/20 transition-colors">
                    {a}
                  </span>
                ))}
              </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-[#0AC4E0]/60 backdrop-blur-xl" onClick={() => setIsModalOpen(false)}></div>
          <div className="relative bg-[#111114] w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[3rem] border border-gray-800 shadow-2xl p-10 animate-in fade-in zoom-in-95 duration-300">
            <div className="flex items-center justify-between mb-12">
              ...
              <button 
                ...
                className="p-2.5 bg-[#0AC4E0] text-white hover:text-white hover:bg-gray-800 rounded-xl transition-all border border-gray-800"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <select 
                    required 
                    className="w-full px-6 py-4 bg-[#0AC4E0]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all shadow-inner appearance-none cursor-pointer"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  ...
                  <input 
                    ...
                    required 
                    placeholder="0"
                    className="w-full px-6 py-4 bg-[#0AC4E0]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700"
              ...
              <div className="space-y-3">
                ...
                <input 
                  ...
                  className="w-full px-6 py-4 bg-[#0AC4E0]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700 font-mono tracking-tighter"
                  value={formData.amenities}
                  onChange={(e) => setFormData({ ...formData, amenities: e.target.value })}
                />
              </div>

              <div className="flex items-center gap-4 bg-[#0AC4E0]/30 p-6 rounded-2xl border border-gray-800 transition-colors hover:border-red-500/30 group">
                <input 
                  type="checkbox" 
                  id="maintenance" 
                  className="w-6 h-6 border-gray-800 bg-[#0AC4E0] rounded-lg checked:bg-[#0B2D72] checked:border-[#0B2D72] appearance-none cursor-pointer transition-all flex items-center justify-center after:content-[''] after:hidden checked:after:block after:w-2 after:h-4 after:border-r-2 after:border-b-2 after:border-black after:rotate-45"
