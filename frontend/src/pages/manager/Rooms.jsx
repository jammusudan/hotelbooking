        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#111114] w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[3rem] border border-gray-800 shadow-2xl p-10 animate-in fade-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex items-center gap-4 bg-[#7FB77E]/30 p-6 rounded-2xl border border-gray-800 transition-colors hover:border-red-500/30 group">
                <input 
                  type="checkbox" 
                  id="maintenance" 
                  className="w-6 h-6 border-gray-800 bg-[#7FB77E] rounded-lg checked:bg-[#0B2D72] checked:border-[#0B2D72] appearance-none cursor-pointer transition-all flex items-center justify-center after:content-[''] after:hidden checked:after:block after:w-2 after:h-4 after:border-r-2 after:border-b-2 after:border-black after:rotate-45"
