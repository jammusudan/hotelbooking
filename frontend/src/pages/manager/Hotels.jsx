    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12">
        <div>
          ...
          <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] mt-6">Manage and curate your verified properties.</p>
        </div>
        <button 
          onClick={() => handleOpenModal()}
          className="flex items-center justify-center gap-3 bg-gold-500 text-black px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white hover:text-black transition-all shadow-lg shadow-gold-500/20 active:scale-95 group"
        >
      ...
      {loading && hotels.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
          {hotels.map((hotel) => (
            <div key={hotel._id} className="bg-[#111114] rounded-[2.5rem] overflow-hidden border border-gray-800/50 hover:border-gold-500/30 transition-all group relative flex flex-col">
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="flex items-center gap-2 text-gray-500 text-[10px] font-black uppercase tracking-widest mb-6 border-b border-gray-800 pb-4">
                  <MapPin className="w-3.5 h-3.5 text-gold-500" />
                  <span className="truncate">{hotel.city}, {hotel.country}</span>
                </div>

                <p className="text-gray-400 text-xs line-clamp-3 italic leading-relaxed mb-8 flex-1">
                  "{hotel.description}"
                </p>
                ...
                <div className="mt-auto grid grid-cols-2 gap-4">
                  <button 
                    ...
                    className="flex items-center justify-center gap-2 py-3.5 bg-gray-800/30 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-gold-500 hover:text-black transition-all border border-gray-700/50"
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2">Hotel Name</label>
                  <input 
                    required 
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2">City</label>
                  <input 
                    required 
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2">Description</label>
                <textarea 
                  required 
                  rows="4"
                  className="w-full px-6 py-4 bg-gray-900/50 border border-gray-800 rounded-2xl focus:border-gold-500/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700 resize-none italic"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2">Address</label>
                  <input 
                    required 
                    className="w-full px-6 py-4 bg-gray-900/50 border border-gray-800 rounded-2xl focus:border-gold-500/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2">Country</label>
                  <input 
                    required 
                    className="w-full px-6 py-4 bg-gray-900/50 border border-gray-800 rounded-2xl focus:border-gold-500/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700"
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2">Hotel Amenities</label>
                <input 
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between border-b border-gray-800 pb-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] ml-2 font-serif">Visual Assets (Gallery)</label>
                  <button 
                    type="button" 
                    onClick={handleAddImageField}
                    className="text-[10px] font-black text-gold-500 hover:text-white uppercase tracking-widest flex items-center gap-2 transition-colors"
                  >
                ...
                {formData.images.map((img, idx) => (
                  <div key={idx} className="flex gap-4 animate-in slide-in-from-left-4 duration-300">
                    <div className="relative flex-1">
                      ...
                      <input 
                        className="w-full pl-14 pr-6 py-4 bg-gray-900/50 border border-gray-800 rounded-2xl focus:border-gold-500/50 outline-none font-bold text-white transition-all text-sm placeholder:text-gray-700"
