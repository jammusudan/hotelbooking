    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-3 bg-[#0B2D72] text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-[#7FB77E] hover:text-black transition-all shadow-lg shadow-[#0B2D72]/20 active:scale-95 group"
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  required 
                  rows="4"
                  className="w-full px-6 py-4 bg-[#7FB77E]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700 resize-none italic"
                ...
                {formData.images.map((img, idx) => (
                  <div key={idx} className="flex gap-4 animate-in slide-in-from-left-4 duration-300">
                    <div className="relative flex-1">
                      ...
                      <input 
                        className="w-full pl-14 pr-6 py-4 bg-[#7FB77E]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all text-sm placeholder:text-gray-700"
