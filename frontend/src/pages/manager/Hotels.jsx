            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  required 
                  rows="4"
                  className="w-full px-6 py-4 bg-[#ACBAC4]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all shadow-inner placeholder:text-gray-700 resize-none italic"
                ...
                {formData.images.map((img, idx) => (
                  <div key={idx} className="flex gap-4 animate-in slide-in-from-left-4 duration-300">
                    <div className="relative flex-1">
                      ...
                      <input 
                        className="w-full pl-14 pr-6 py-4 bg-[#ACBAC4]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none font-bold text-white transition-all text-sm placeholder:text-gray-700"
