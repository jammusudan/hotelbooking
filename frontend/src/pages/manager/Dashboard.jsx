  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <header className="mb-12">
        ...
        <p className="text-[10px] font-black text-white uppercase tracking-[0.3em] mt-6">Protocol established: Tracking property performance and customer telemetry.</p>
      </header>
        ...
        {statsCards.map((card, i) => (
          <div key={card.title} className="bg-transparent p-8 transition-all group relative overflow-hidden">
            ...
            <div className="text-3xl mb-4 grayscale group-hover:grayscale-0 transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)]">
              <card.icon className={`w-8 h-8 ${card.color.replace('text-', 'text-white')}`} />
            </div>
            <div className="text-3xl font-serif font-black text-white mb-1">{card.value}</div>
            <div className="text-[10px] font-black uppercase tracking-widest text-white">{card.title}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="bg-transparent p-10 relative overflow-hidden group">
          ...
          <h3 className="text-lg font-serif font-black text-white mb-8 uppercase italic border-b border-white/10 pb-4">Booking Analytics</h3>
        ...
        <div className="bg-transparent p-10 relative overflow-hidden group">
          ...
          <h3 className="text-lg font-serif font-black text-white mb-8 uppercase italic border-b border-white/10 pb-4">Revenue Growth</h3>
          <div className="h-[300px]">
            <Bar 
              data={{
                ...revenueData,
