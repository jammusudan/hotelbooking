            ...
            <div key={review._id} className="bg-[#111114] rounded-[2.5rem] p-10 border border-gray-800/50 hover:border-[#0B2D72]/30 transition-all group relative flex flex-col shadow-2xl overflow-hidden">
              ...
              <div className="mb-10 flex justify-between items-start">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-[#ACBAC4] border border-gray-800 flex items-center justify-center text-white font-black shadow-inner group-hover:scale-110 transition-transform">
              ...
              <div className="pt-8 border-t border-gray-800/50">
                ...
                {activeReplyId === review._id && (
                  <div className="space-y-4 animate-in slide-in-from-top-2 duration-300">
                    ...
                    <textarea 
                      className="w-full p-6 bg-[#ACBAC4]/50 border border-gray-800 rounded-2xl focus:border-[#0B2D72]/50 outline-none text-sm font-bold text-white transition-all shadow-inner placeholder:text-gray-800 resize-none italic"
