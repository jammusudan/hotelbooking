      ...
      <div className="bg-[#111114] p-6 rounded-3xl border border-gray-800/50 shadow-2xl flex flex-col md:flex-row gap-6">
        <div className="relative flex-1 group">
          ...
          <input 
            ...
            className="w-full pl-16 pr-6 py-4 bg-[#0AC4E0]/50 border border-gray-800/80 rounded-2xl focus:border-[#0B2D72]/50 outline-none text-sm font-bold text-gray-900 transition-all shadow-inner placeholder:text-gray-700"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
          />
        </div>
        <div className="flex items-center gap-4 bg-[#0AC4E0]/50 border border-gray-800/80 rounded-2xl px-6 py-2 group hover:border-[#0B2D72]/30 transition-all">
      ...
      {loading && bookings.length === 0 ? (
        ...
        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 shadow-2xl overflow-hidden">
            ...
            <table className="w-full text-left font-sans">
              ...
              <tbody className="divide-y divide-gray-800/30">
                {filteredBookings.map((booking) => (
                  <tr key={booking._id} className="hover:bg-[#0AC4E0]/50 transition-all group">
                    <td className="px-10 py-10">
                      <div className="flex items-center gap-6">
                        <div className="w-14 h-14 rounded-2xl bg-[#0AC4E0] border border-gray-800 flex items-center justify-center text-gray-900 group-hover:scale-110 transition-transform shadow-inner">
                    ...
                    <td className="px-10 py-10">
                      <div className="space-y-2">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#0AC4E0] border border-gray-800 rounded-lg text-[9px] font-black text-gray-600 uppercase tracking-widest">
                        ...
                        {updatingId === booking._id ? (
                          ...
                          <>
                            ...
                            <button 
                              ...
                              className="p-3 bg-[#0AC4E0] text-gray-900 hover:text-gray-900 rounded-xl transition-all border border-gray-800 shadow-lg hover:border-[#0B2D72]/30 group/inv"
          ...
          {filteredBookings.length === 0 && (
            <div className="text-center py-32 bg-[#0AC4E0]/20 group">
