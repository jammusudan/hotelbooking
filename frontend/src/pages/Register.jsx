      ...
      <div className="max-w-md w-full relative group">
        ...
        <div className="relative space-y-8 bg-[#EDF7BD] border border-white/5 p-10 md:p-14 rounded-[3rem] shadow-2xl overflow-hidden">
          ...
          <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <input type="text" required className="w-full bg-[#EDF7BD]/40 border border-white/10 p-4 pl-12 rounded-xl text-black focus:border-transparent/50 outline-none transition-all font-medium text-sm" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <input type="email" required className="w-full bg-[#EDF7BD]/40 border border-white/10 p-4 pl-12 rounded-xl text-black focus:border-transparent/50 outline-none transition-all font-medium text-sm" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <input type="password" required className="w-full bg-[#EDF7BD]/40 border border-white/10 p-4 pl-12 rounded-xl text-black focus:border-transparent/50 outline-none transition-all font-medium text-sm" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
              </div>
              
              <div className="space-y-2">
                <label className="text-[9px] font-black text-black uppercase tracking-[0.4em] ml-1">Select Role</label>
                <select value={role} onChange={(e) => setRole(e.target.value)} className="w-full bg-[#EDF7BD]/40 border border-white/10 p-4 rounded-xl text-black focus:border-transparent/50 outline-none transition-all font-medium text-sm appearance-none cursor-pointer">
            ...
            <button type="submit" className="w-full group relative flex items-center justify-center gap-3 py-5 bg-transparent text-black font-black uppercase tracking-[0.4em] text-[11px] rounded-2xl hover:bg-[#EDF7BD] transition-all transform active:scale-95 mt-8">
          ...
          <div className="text-center pt-8 border-t border-white/5 relative z-10">
            <p className="text-[10px] font-black text-black uppercase tracking-[0.4em]">
              ...
              <Link to="/login" className="text-black font-black ml-2 hover:underline decoration-[transparent]/30 underline-offset-4">
                Login here
              </Link>
            </p>
          </div>
