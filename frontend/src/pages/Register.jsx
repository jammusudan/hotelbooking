...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#85C79A] py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative group">
        ...
        <div className="relative space-y-8 bg-[#85C79A] border border-white/5 p-10 md:p-14 rounded-[3rem] shadow-2xl overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <input type="text" required className="w-full bg-[#85C79A]/40 border border-white/10 p-4 pl-12 rounded-xl text-white focus:border-[#0B2D72]/50 outline-none transition-all font-medium text-sm" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <input type="email" required className="w-full bg-[#85C79A]/40 border border-white/10 p-4 pl-12 rounded-xl text-white focus:border-[#0B2D72]/50 outline-none transition-all font-medium text-sm" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <input type="password" required className="w-full bg-[#85C79A]/40 border border-white/10 p-4 pl-12 rounded-xl text-white focus:border-[#0B2D72]/50 outline-none transition-all font-medium text-sm" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
              </div>
              
              <div className="space-y-2">
                <label className="text-[9px] font-black text-gray-600 uppercase tracking-[0.4em] ml-1">Select Role</label>
                <select value={role} onChange={(e) => setRole(e.target.value)} className="w-full bg-[#85C79A]/40 border border-white/10 p-4 rounded-xl text-white focus:border-[#0B2D72]/50 outline-none transition-all font-medium text-sm appearance-none cursor-pointer">
                   <option value="customer" className="bg-[#85C79A]">Customer (Book Hotels)</option>
                   <option value="manager" className="bg-[#85C79A]">Manager (Manage Hotels)</option>
                   <option value="admin" className="bg-[#85C79A]">Admin (Control Center)</option>
                </select>
              </div>
            </div>

            <button type="submit" className="w-full group relative flex items-center justify-center gap-3 py-5 bg-[#0B2D72] text-white font-black uppercase tracking-[0.4em] text-[11px] rounded-2xl hover:bg-white transition-all transform active:scale-95 mt-8">
