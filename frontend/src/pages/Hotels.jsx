      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-1/4">
            <div className="bg-[#85C79A] p-8 rounded-[2.5rem] border border-white/5 shadow-2xl sticky top-32 overflow-hidden group">
              ...
              <div className="mb-10 relative z-10">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <input 
                    ...
                    className="w-full bg-[#85C79A]/40 border border-white/10 rounded-xl p-3 text-xs text-white focus:border-[#0B2D72]/50 focus:bg-[#85C79A]/60 outline-none transition-all font-bold placeholder:text-gray-700"
              ...
              <div className="mb-10 relative z-10">
                ...
                <div className="space-y-3">
                  <input 
                    type="date" 
                    className="w-full bg-[#85C79A]/40 border border-white/10 rounded-xl p-3 text-xs text-white focus:border-[#0B2D72]/50 outline-none transition-all font-bold color-scheme-dark"
              ...
              <div className="mb-10 relative z-10">
                ...
                <div className="flex items-center gap-1 bg-[#85C79A]/40 p-3 rounded-xl border border-white/10">
                  {[1, 2, 3, 4, 5].map(star => (
                    <button 
                      key={star}
                  ...
                  {amenitiesOptions.map(amenity => (
                    <label key={amenity} className="flex items-center text-[10px] font-bold text-white cursor-pointer group/item">
                      <input 
                        ...
                        className="w-4 h-4 rounded bg-[#85C79A]/40 border-white/10 text-white mr-3 focus:ring-offset-black focus:ring-[#0B2D72] transition-all"
                      />
          ...
          <main className="lg:w-3/4 space-y-12">
            ...
            {/* Search Consol */}
            <form onSubmit={handleSearch} className="flex w-full bg-[#85C79A] border border-white/10 rounded-[2.5rem] shadow-2xl relative group overflow-hidden">
            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {[1,2,3,4].map(i => (
                  <div key={i} className="h-[500px] bg-[#85C79A] rounded-[3rem] border border-white/5 animate-pulse"></div>
                ))}
              </div>
            ) : hotels.length === 0 ? (
              <div className="text-center py-24 bg-[#85C79A] rounded-[3rem] border border-dashed border-white/5 border-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {hotels.map((hotel) => {
                  ...
                  <Link key={hotel._id} to={`/hotels/${hotel._id}`} className="group h-full">
                    <div className="bg-[#85C79A] border border-white/5 rounded-[3rem] overflow-hidden flex flex-col h-full transition-all duration-700 hover:border-[#0B2D72]/30 hover:shadow-[0_40px_80px_-20px_rgba(212,175,55,0.1)] group-hover:-translate-y-3 shadow-2xl">
                      ...
                      <div className="relative h-[300px] overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#85C79A] via-transparent to-transparent opacity-60"></div>
                        
                        {/* Rating Component */}
                        <div className="absolute top-6 right-6 bg-[#85C79A]/60 backdrop-blur-md px-4 py-2 rounded-2xl border border-white/10 flex items-center gap-2 shadow-2xl z-20">
