      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#EDF7BD] p-10 rounded-[3rem] border border-white/5 shadow-2xl">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-3">
                   ...
                   <input 
                     type="password" 
                     placeholder="••••••••"
                     className="w-full bg-[#EDF7BD]/50 border border-gray-800 rounded-2xl p-4 text-black font-bold outline-none focus:border-indigo-400/50 transition-colors"
                   />
                 </div>
                 <div className="space-y-3">
               ...
               <div className="pt-4 flex justify-end">
                  <button className="flex items-center gap-3 bg-[#EDF7BD]/5 text-black px-8 py-4 rounded-xl font-black uppercase text-[10px] tracking-[0.3em] hover:bg-indigo-500 transition-all border border-white/10 shadow-xl active:scale-95">
          ...
          <div className="bg-[#EDF7BD] p-10 rounded-[3rem] border border-white/5 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10">
              ...
              <button disabled className="px-6 py-3 bg-[#EDF7BD] text-black rounded-xl text-[10px] font-black uppercase tracking-widest cursor-not-allowed border border-gray-800">
                  Active Profile
              </button>
          </div>
