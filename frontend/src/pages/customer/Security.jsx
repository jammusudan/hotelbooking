...
const Security = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0AC4E0] py-20 px-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#0AC4E0] p-10 rounded-[3rem] border border-white/5 shadow-2xl">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-3">
                   ...
                   <input 
                     type="password" 
                     placeholder="••••••••"
                     className="w-full bg-[#0AC4E0]/50 border border-gray-800 rounded-2xl p-4 text-gray-900 font-bold outline-none focus:border-indigo-400/50 transition-colors"
                   />
                 </div>
                 <div className="space-y-3">
          ...
          {/* MFA Module */}
          <div className="bg-[#0AC4E0] p-10 rounded-[3rem] border border-white/5 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10">
              ...
              <button disabled className="px-6 py-3 bg-[#0AC4E0] text-gray-900 rounded-xl text-[10px] font-black uppercase tracking-widest cursor-not-allowed border border-gray-800">
                  Active Profile
              </button>
          </div>
