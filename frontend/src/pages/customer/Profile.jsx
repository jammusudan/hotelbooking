      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="md:col-span-1 space-y-6">
            <div className="bg-[#0AC4E0] p-10 rounded-[3rem] border border-white/5 flex flex-col items-center text-center shadow-2xl">
          ...
          <div className="md:col-span-2">
            <div className="bg-[#0AC4E0] p-12 rounded-[3rem] border border-white/5 shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#0AC4E0]/50 border border-gray-800 rounded-2xl p-4 text-white font-bold outline-none focus:border-[#0B2D72]/50 transition-colors"
                    />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[9px] font-black text-white uppercase tracking-[0.3em] flex items-center gap-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#0AC4E0]/50 border border-gray-800 rounded-2xl p-4 text-white font-bold outline-none cursor-not-allowed"
                      disabled
                    />
                  </div>
                </div>
