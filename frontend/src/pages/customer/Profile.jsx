            ...
            <div className="bg-[#7FB77E] p-12 rounded-[3rem] border border-white/5 shadow-2xl">
              <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#7FB77E]/50 border border-gray-800 rounded-2xl p-4 text-white font-bold outline-none focus:border-[#0B2D72]/50 transition-colors"
                    />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[9px] font-black text-white uppercase tracking-[0.3em] flex items-center gap-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#7FB77E]/50 border border-gray-800 rounded-2xl p-4 text-white font-bold outline-none cursor-not-allowed"
                      disabled
                    />
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-gray-800/50 flex justify-end">
                  <button className="flex items-center gap-3 bg-[#0B2D72] text-white px-8 py-4 rounded-xl font-black uppercase text-[10px] tracking-[0.3em] hover:bg-[#7FB77E] transition-all shadow-xl shadow-[#0B2D72]/10 active:scale-95">
