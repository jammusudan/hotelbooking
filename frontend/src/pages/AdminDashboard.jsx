...
const AdminDashboard = () => {
    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-gray-950">
            <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-gold-500 border-solid"></div>
        </div>
    );
    ...
    return (
        <div className="font-sans text-gray-300">
            ...
            {/* MAIN CONTENT */}
            <main className="max-w-7xl mx-auto px-8 py-12 bg-[#0a0a0b]">
                <header className="mb-12">
                    ...
                    <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] mt-6">
                    ...
                    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={i} className="bg-[#111114] border border-gray-800/50 p-8 rounded-[2rem] hover:border-gold-500/30 transition-all group">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="bg-[#111114] p-10 rounded-[2.5rem] border border-gray-800/50">
                                ...
                                <div className="space-y-4">
                                    {feed.map(item => (
                                        <div key={item.id} className="bg-gray-900/50 p-6 rounded-3xl border border-gray-800/50 animate-in slide-in-from-top-4">
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="text-[9px] font-black text-gold-500 uppercase tracking-widest">{item.type === 'booking' ? 'Transaction' : 'New Patron'}</span>
                                        ...
                                        <div key={i} className="flex items-center gap-6">
                                            ...
                                            <div className="flex-grow">
                                                <div className="flex justify-between mb-2">
                                                    <span className="text-sm font-black text-gray-300 uppercase">{hotel.hotelInfo.name}</span>
                                                    <span className="text-xs font-black text-gold-500">{hotel.count}</span>
                                                </div>
                                                <div className="h-1.5 bg-gray-900 rounded-full overflow-hidden">
                                                    <div className="h-full bg-gold-500 shadow-[0_0_10px_rgba(212,175,55,0.5)]" style={{ width: `${(hotel.count / (analytics.totalBookings || 1)) * 100}%` }}></div>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                            ...
                            <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                                <table className="w-full text-left">
                                    <thead className="bg-[#1a1a1e]">
                                        <tr>
                                            <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Sanctuary</th>
                                            <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Curator</th>
                                            <th className="p-8 text-right text-[10px] font-black uppercase tracking-widest text-gray-500">Protocol</th>
                                        </tr>
                                    </thead>
                                        ...
                                        {unapprovedHotels.map(h => (
                                            <tr key={h._id} className="hover:bg-gray-800/20 transition-colors">
                                                <td className="p-8">
                                                    ...
                                                    <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-1">📍 {h.city}</div>
                                                </td>
                                                <td className="p-8">
                                                    <div className="text-sm font-bold text-gray-300">{h.managerId?.name || 'External'}</div>
                    ...
                    <div className="animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                            <table className="w-full text-left">
                                <thead className="bg-[#1a1a1e]">
                                    <tr>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Verified Hotel</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Performance</th>
                                        <th className="p-8 text-right text-[10px] font-black uppercase tracking-widest text-gray-500">Operation</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {approvedHotels.map(h => (
                                        <tr key={h._id} className="hover:bg-gray-800/20 transition-colors">
                                            <td className="p-8">
                                                <div className="text-lg font-serif font-black text-white italic">{h.name}</div>
                                                <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-1">📍 {h.city}, {h.country}</div>
                                            </td>
                                            <td className="p-8">
                    ...
                    <div className="animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-[#1a1a1e]">
                                    <tr>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Patron Identity</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Status Protocol</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Induction Date</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {usersList.map(u => (
                                        <tr key={u._id} className="hover:bg-gray-800/20 transition-colors">
                                            <td className="p-8 flex items-center gap-6">
                                                <div className="w-12 h-12 rounded-2xl bg-gray-900 border border-gray-800 text-gold-500 flex items-center justify-center font-black text-xs shadow-inner uppercase">{u.name.charAt(0)}</div>
                                                <div>
                                                    <div className="text-sm font-black text-white italic">{u.name}</div>
                                                    <div className="text-[10px] font-medium text-gray-500 lowercase">{u.email}</div>
                                                </div>
                                            </td>
                                            <td className="p-8">
                                                <span className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest italic border ${u.role === 'admin' ? 'bg-indigo-500/10 text-indigo-500 border-indigo-500/20' : u.role === 'manager' ? 'bg-amber-500/10 text-amber-500 border-amber-500/20' : 'bg-gray-800 text-gray-500 border-gray-700'}`}>
                                                    {u.role}
                                                </span>
                                            </td>
                                            <td className="p-8">
                    ...
                    <div className="animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                            <table className="w-full text-left">
                                <thead className="bg-[#1a1a1e]">
                                    <tr>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Folio ID</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Patron & Estate</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Value</th>
                                        <th className="p-8 text-right text-[10px] font-black uppercase tracking-widest text-gray-500">Standing</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {bookingsList.map(res => (
                                        <tr key={res._id} className="hover:bg-gray-800/20 transition-colors">
                                            <td className="p-8">
                                                <div className="text-xs font-mono font-black text-gold-500/70">#{res._id.slice(-8).toUpperCase()}</div>
                                            ...
                                            <td className="p-8">
                                                ...
                                                <div className="text-[10px] font-black text-gray-500 italic uppercase mt-0.5">{res.hotelId?.name} — {res.roomId?.type}</div>
                                            </td>
                                            <td className="p-8">
                    ...
                    <div className="animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                            <table className="w-full text-left">
                                <thead className="bg-[#1a1a1e]">
                                    <tr>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Transaction ID</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Patron</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Hotel</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Value</th>
                                        <th className="p-8 text-right text-[10px] font-black uppercase tracking-widest text-gray-500">Status</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {paymentsList.map(pay => (
                                        <tr key={pay._id} className="hover:bg-gray-800/20 transition-colors">
                                            <td className="p-8">
                                                <div className="text-xs font-mono text-gold-500/70 uppercase">#{pay.razorpayPaymentId?.slice(-10)}</div>
                                            </td>
                                            <td className="p-8">
                                            ...
                                            <td className="p-8">
                                                <div className="text-xs font-bold text-gray-300 uppercase">{pay.hotelId?.name}</div>
                                            </td>
                ...
                {activeTab === 'Promotions' && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="flex justify-between items-center">
                            ...
                            <button onClick={() => setShowPromoModal(true)} className="bg-gold-500 text-black px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-gold-500/20 active:scale-95 transition-all">Authorize New Promo</button>
                        </div>
                        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                            <table className="w-full text-left">
                                <thead className="bg-[#1a1a1e]">
                                    <tr>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Property</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Code</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Discount</th>
                                        <th className="p-8 text-[10px] font-black uppercase tracking-widest text-gray-500">Expiry</th>
                                        <th className="p-8 text-right text-[10px] font-black uppercase tracking-widest text-gray-500">Status</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {promotionsList.map(p => (
                                        <tr key={p._id} className="hover:bg-gray-800/20 transition-colors">
                                            <td className="p-8 text-xs font-bold text-gray-400 italic max-w-[150px] truncate" title={p.hotelId ? p.hotelId.name : 'Global Collection'}>
                                                {p.hotelId ? p.hotelId.name : 'Global Collection'}
                                            </td>
                                            <td className="p-8 font-mono text-gold-500 font-black">{p.code}</td>
                                            <td className="p-8 text-xs font-bold text-white italic">{p.discount}{p.type === 'percentage' ? '%' : ' INR'} OFF</td>
                                            <td className="p-8 text-[10px] text-gray-500 font-black uppercase">{new Date(p.expiryDate).toLocaleDateString()}</td>
                                            <td className="p-8 text-right">
                    ...
                    <div className="animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="bg-[#111114] rounded-[2.5rem] border border-gray-800/50 overflow-hidden">
                            <table className="w-full text-left">
                                <thead className="bg-[#1a1a1e]">
                                    <tr>
                                        <th className="p-10 text-[10px] font-black uppercase tracking-widest text-gray-500">Patron & Hotel</th>
                                        <th className="p-10 text-[10px] font-black uppercase tracking-widest text-gray-500">Reflection</th>
                                        <th className="p-10 text-right text-[10px] font-black uppercase tracking-widest text-gray-500">Moderation</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {reviewsList.map(r => (
                                        <tr key={r._id} className="hover:bg-gray-800/20 transition-colors">
                                            <td className="p-10 min-w-[300px]">
                                                ...
                                                <div className="text-[10px] font-bold text-gold-500 uppercase tracking-widest mt-1">@ {r.hotelId?.name}</div>
                                            </td>
                                            <td className="p-10">
                                                <div className="flex gap-1 mb-3">
                                                    {[...Array(5)].map((_, i) => (
                                                        <span key={i} className={i < r.rating ? 'text-gold-500' : 'text-gray-800'}>★</span>
                                                    ))}
                                                </div>
                                                <p className="text-sm font-medium text-gray-400 leading-relaxed max-w-xl italic">"{r.comment}"</p>
                                            </td>
                    ...
                    <div className="space-y-12 animate-in fade-in slide-in-from-right-8 duration-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-[#111114] p-10 rounded-[2.5rem] border border-gray-800/50 text-center">
                                <div className="text-4xl font-serif font-black text-gold-500 mb-2 italic">₹{(analytics.totalRevenue / (analytics.totalBookings || 1)).toFixed(0)}</div>
                    ...
                    <div className="bg-[#111114] w-full max-w-2xl rounded-[3rem] shadow-2xl relative border border-white/10 overflow-hidden animate-in zoom-in-95 duration-500">
                        <div className="p-16">
                            <header className="text-center mb-16">
                                <h3 className="text-[10px] font-black text-gold-500 uppercase tracking-[0.6em] mb-4 italic">Promotional Protocol</h3>
                            ...
                            <form onSubmit={handleCreatePromo} className="space-y-8">
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-black/40 border border-white/10 p-5 rounded-2xl text-white outline-none focus:border-gold-500 font-black tracking-widest uppercase transition-all"
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-black/40 border border-white/10 p-5 rounded-2xl text-white outline-none focus:border-gold-500 font-black transition-all"
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <select 
                                            className="w-full bg-black/40 border border-white/10 p-5 rounded-2xl text-white outline-none focus:border-gold-500 font-bold transition-all appearance-none"
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <input 
                                            type="date" required
                                            className="w-full bg-black/40 border border-white/10 p-5 rounded-2xl text-white outline-none focus:border-gold-500 font-bold transition-all color-scheme-dark"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full bg-black/40 border border-white/10 p-5 rounded-2xl text-white outline-none focus:border-gold-500 font-medium italic transition-all resize-none"
                                ...
                                <div className="flex gap-4 pt-4">
                                    <button 
                                        ...
                                        className="flex-grow py-5 bg-white/5 text-gray-500 font-black uppercase tracking-widest text-[10px] rounded-2xl hover:bg-white hover:text-black transition-all"
                                    >
                                        Cancel Protocol
                                    </button>
                                    <button 
                                        type="submit"
                                        className="flex-[2] py-5 bg-gold-500 text-black font-black uppercase tracking-[0.4em] text-[10px] rounded-2xl hover:bg-white transition-all shadow-xl shadow-gold-500/20 transform active:scale-95"
                                    >
