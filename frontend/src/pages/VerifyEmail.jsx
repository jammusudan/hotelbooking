      ...
      <div className="max-w-md w-full py-12 px-10 bg-white shadow-2xl rounded-xl text-center space-y-8 transition-all duration-700">
        {status === 'verifying' && (
          <div className="animate-in fade-in duration-1000 space-y-6">
            ...
            <p className="text-gray-500 text-sm font-bold uppercase tracking-widest">Verifying your credentials...</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="animate-in zoom-in duration-500 space-y-6">
            ...
            <Link to="/login" className="inline-block w-full bg-black text-white py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-gray-900 transition-all shadow-lg mt-4">
              Step Inside
            </Link>
          </div>
        )}
        ...
        {status === 'error' && (
          <div className="animate-in shake-in duration-500 space-y-6">
            ...
            <Link to="/register" className="inline-block w-full border-2 border-black text-black py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-gray-50 transition-all mt-4">
