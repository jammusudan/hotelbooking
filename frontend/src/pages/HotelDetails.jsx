                  ...
                  >
                    ...
                    <div className="flex-grow flex flex-col justify-center">
                      ...
                      <div className="flex flex-wrap gap-3 mt-auto">
                        ...
                        <span className={`text-[8px] font-black uppercase tracking-widest px-4 py-2 rounded-full border ${room.isMaintenance
          ...
          <div className="sticky top-28 bg-[#003049] border border-white/10 rounded-[3rem] md:rounded-[4rem] p-8 md:p-12 shadow-3xl overflow-hidden">
            ...
            <form onSubmit={handleBooking} className="space-y-8 md:space-y-10">
              ...
              {availability !== null && !checkingAvailability && (
                <div className={`p-6 rounded-2xl border flex flex-col gap-2 ${availability.available
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em]">
                      {availability.available ? 'Sanctuary Available' : 'Selected Dates Not Available'}
                    </span>
                  </div>
                  <p className="text-[9px] opacity-70 uppercase tracking-widest font-serif italic">
                    {availability.available
                      ...
                      : 'The selected dates are already booked and not available'}
                  </p>
                </div>
              )}
