...
const HotelDetails = () => {
  ...
  if (!hotel) return (
    <div className="min-h-screen flex items-center justify-center bg-[#85C79A] text-white">
  ...
  return (
    <div className="bg-[#85C79A] min-h-screen text-white pt-20 overflow-x-hidden">
      ...
      <div className="relative h-[85vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#85C79A] via-[#85C79A]/40 to-transparent"></div>
        ...
        <div className="absolute bottom-12 left-0 w-full p-4 md:p-16 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-12 z-10">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-4 p-4 bg-[#85C79A]/40 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] animate-in fade-in slide-in-from-right duration-1000">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-16 py-32 grid grid-cols-1 lg:grid-cols-12 gap-24">
        ...
        <div className="lg:col-span-8 space-y-32">
          ...
          <section>
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
               {(hotel.amenities || []).map(amenity => (
                 <div key={amenity} className="group p-8 bg-[#85C79A] border border-white/5 rounded-[2rem] hover:border-[#0B2D72]/30 transition-all flex flex-col items-center text-center gap-5">
          ...
          <section>
             ...
             <div className="space-y-8">
               {rooms.length === 0 ? (
                 <div className="p-20 bg-[#85C79A] rounded-[3rem] border border-white/5 text-center">
                      ...
                      className={`group flex flex-col md:flex-row gap-8 p-8 rounded-[3rem] border transition-all duration-700 ${
                        room.isMaintenance 
                          ...
                          : selectedRoomId === room._id 
                            ...
                            : 'bg-[#85C79A] border-white/5 hover:border-[#0B2D72]/30 cursor-pointer'
                      }`}
                    >
                      <div className="w-full md:w-80 h-60 rounded-[2rem] overflow-hidden relative group-hover:shadow-2xl transition-all">
                        ...
                        />
                        {room.isMaintenance && (
                            <div className="absolute inset-0 bg-[#85C79A]/80 flex items-center justify-center backdrop-blur-sm">
                      ...
                      <div className="flex-grow flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-4 mt-auto">
                           {selectedRoomId === room._id && !room.isMaintenance && (
                             <span className="text-[9px] font-black uppercase tracking-widest bg-[#85C79A] text-white px-4 py-2 rounded-full border border-black/10">Active Choice</span>
                           )}
          ...
          {/* Testimonials */}
          <section className="bg-[#85C79A] p-16 rounded-[4rem] border border-white/5 relative overflow-hidden">
             ...
             {reviews.length === 0 ? (
               ...
               <div className="space-y-10">
                 {reviews.map(rev => (
                   <div key={rev._id} className="p-12 bg-[#85C79A]/40 rounded-[3rem] border border-white/5 hover:border-[#0B2D72]/20 transition-all group">
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-32 bg-[#85C79A] border border-white/5 rounded-[4rem] p-12 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden">
                ...
                <div className="space-y-4">
                   ...
                   <div className="relative group">
                      ...
                      <input 
                        ...
                        className="w-full bg-[#85C79A]/40 border border-white/10 rounded-2xl p-5 pl-16 text-sm font-black color-scheme-dark outline-none focus:border-[#0B2D72] transition-all"
                      />
                   </div>
                </div>
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="relative group">
                        ...
                        <input 
                          ...
                          className="w-full bg-[#85C79A]/40 border border-white/10 rounded-2xl p-4 pl-12 text-sm font-black outline-none focus:border-[#0B2D72] transition-all"
                        />
                     </div>
                  </div>
                  <div className="space-y-4">
                ...
                <div className="space-y-4">
                   ...
                   <div className="relative group">
                      ...
                      <select 
                        ...
                        className="w-full bg-[#85C79A]/40 border border-white/10 rounded-2xl p-5 pl-16 text-sm font-black outline-none focus:border-[#0B2D72] transition-all appearance-none cursor-pointer"
                        required
                      >
                        <option value="" disabled className="bg-[#85C79A]">Select Tier</option>
                        {rooms.map(r => (
                          <option key={r._id} value={r._id} className="bg-[#85C79A] text-white">
