...
const HotelDetails = () => {
  ...
  if (!hotel) return (
    <div className="min-h-screen flex items-center justify-center bg-[#7FB77E] text-black">
  ...
  return (
    <div className="bg-[#7FB77E] min-h-screen text-black pt-20 overflow-x-hidden">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
               {(hotel.amenities || []).map(amenity => (
                 <div key={amenity} className="group p-8 bg-[#7FB77E] border border-white/5 rounded-[2rem] hover:border-[#0B2D72]/30 transition-all flex flex-col items-center text-center gap-5">
                   <div className="w-14 h-14 bg-[#7FB77E]/5 rounded-2xl flex items-center justify-center text-black group-hover:scale-110 transition-transform">
                      ...
                      <div className="flex-grow flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-4 mt-auto">
                           {selectedRoomId === room._id && !room.isMaintenance && (
                             <span className="text-[9px] font-black uppercase tracking-widest bg-[#7FB77E] text-black px-4 py-2 rounded-full border border-black/10">Active Choice</span>
                           )}
                   ...
                   <div key={rev._id} className="p-12 bg-[#7FB77E]/40 rounded-[3rem] border border-white/5 hover:border-[#0B2D72]/20 transition-all group">
                     <div className="flex items-center gap-8 mb-10">
                        ...
                        <div className="ml-auto hidden md:block">
                           <span className="text-[8px] font-black uppercase tracking-[0.4em] bg-[#7FB77E]/5 border border-white/10 px-6 py-3 rounded-full text-black">Verified Experience</span>
                        </div>
                     </div>
             ...
             <form onSubmit={handleBooking} className="space-y-10">
                ...
                <div className="space-y-4">
                   ...
                   <div className="relative group">
                      ...
                      >
                        ...
                        {rooms.map(r => (
                          <option key={r._id} value={r._id} className="bg-[#7FB77E] text-black">
                ...
                <div className="pt-8 border-t border-white/5">
                   ...
                   <button 
                     ...
                     className="w-full py-6 bg-[#0B2D72] text-black font-black uppercase tracking-[0.5em] rounded-2xl hover:bg-[#7FB77E] hover:shadow-2xl hover:shadow-[#0B2D72]/30 transition-all transform active:scale-95 disabled:opacity-50 disabled:bg-gray-800 disabled:text-black text-[10px]"
                   >
