                                        ...
                                        <div key={room._id} className="bg-[#111114] p-8 rounded-[2.5rem] border border-gray-800/50 shadow-lg flex flex-col group transition-all hover:border-[#0B2D72]/30">
                                            <div className="flex justify-between items-start mb-6">
                                                ...
                                                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <button onClick={() => editRoom(room)} className="p-3 bg-[#EDF7BD] text-black hover:text-black rounded-xl transition-all">✎</button>
                                                    <button onClick={() => handleDeleteRoom(room._id)} className="p-3 bg-[#EDF7BD] text-black hover:text-red-500 rounded-xl transition-all">✕</button>
                                                </div>
                                            </div>
                                                ...
                                                <tbody className="divide-y divide-gray-800/50">
                                                    {reservations.map(res => (
                                                        <tr key={res._id} className="hover:bg-gray-800/10 transition-colors group">
                                                            ...
                                                            <td className="py-8">
                                                                <span className="bg-[#EDF7BD] border border-gray-800 px-4 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest text-black italic">{res.roomId?.type} Suite</span>
                                                            </td>
                                                            <td className="py-8">
