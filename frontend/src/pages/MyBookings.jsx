                ...
                {bookings.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 gap-12">
                        {bookings.map((booking) => (
                            <div key={booking._id} className="group bg-[#003049] rounded-[3rem] border border-white/10 shadow-2xl hover:border-transparent/30 transition-all duration-700 overflow-hidden flex flex-col lg:flex-row shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)]">
                                ...
                                <div className="lg:w-1/3 min-h-[300px] overflow-hidden relative">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-r from-[#003049] via-transparent to-transparent opacity-60"></div>
                                    <div className="absolute top-8 left-8">
                                        <span className={`px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl backdrop-blur-md border border-white/10 ${
                                            ...
                                            booking.status === 'Cancelled' ? 'bg-red-500/20 text-red-400' : 'bg-transparent/20 text-white'
                                        }`}>
                                            {booking.status}
                                        </span>
                                    </div>
                                ...
                                <div className="flex-grow p-12 flex flex-col justify-between">
                                    ...
                                    <div className="mt-12 flex flex-wrap gap-4">
                                        {booking.status === 'Pending' && (
                                            <Link to={`/payment/${booking._id}`} className="bg-transparent text-white px-10 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all shadow-xl shadow-transparent/10 flex items-center gap-2">
                                        ...
                                        {booking.status === 'Confirmed' && (
                                            <Link 
                                                ...
                                                className="bg-white/5 text-white border border-white/10 px-10 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 hover:text-white transition-all flex items-center gap-2"
                                            >
                                        ...
                                        {booking.status === 'Confirmed' && (
                                            <button 
                                                ...
                                                className="bg-transparent text-white px-10 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all shadow-xl shadow-transparent/10 flex items-center gap-2"
                                            >
                                        ...
                                        {booking.paymentStatus === 'Paid' && booking.status === 'Cancelled' && (
                                            <button 
                                                ...
                                                className="bg-transparent/10 text-white border border-transparent/20 px-10 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-transparent hover:text-white transition-all"
                                            >
                                                Request Refund
                                            </button>
                                        )}
                                        ...
                                        {(booking.status === 'Confirmed' || booking.status === 'Pending') && new Date(booking.checkIn) > new Date() && (
                                            <>
                                                <button 
                                                    ...
                                                    className="bg-white/5 text-white border border-white/10 px-10 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-transparent hover:text-white transition-all flex items-center gap-2"
                                                >
                            ...
                            <form onSubmit={handleUpdate} className="space-y-8">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-[#EDF7BD]/40 border border-white/10 rounded-2xl p-4 text-sm text-white focus:border-transparent outline-none transition-all font-bold color-scheme-dark"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-[#EDF7BD]/40 border border-white/10 rounded-2xl p-4 text-sm text-white focus:border-transparent outline-none transition-all font-bold"
                                    />
                                </div>
                                ...
                                <button 
                                    ...
                                    className="w-full bg-transparent text-white font-black uppercase tracking-[0.4em] py-6 rounded-2xl hover:bg-white/10 transition-all transform active:scale-95 disabled:opacity-50 shadow-2xl shadow-transparent/10 text-[10px]"
                                >
