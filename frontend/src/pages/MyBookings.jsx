    ...
    return (
        <div className="bg-white min-h-screen pt-32 pb-24 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                {bookings.length === 0 ? (
                    <div className="text-center py-32 bg-white rounded-[3rem] border border-dashed border-white/10 border-2">
                    ...
                    <div className="grid grid-cols-1 gap-12">
                        {bookings.map((booking) => (
                            <div key={booking._id} className="group bg-white rounded-[3rem] border border-white/5 shadow-2xl hover:border-[#0B2D72]/30 transition-all duration-700 overflow-hidden flex flex-col lg:flex-row shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)]">
                                ...
                                <div className="flex-grow p-12 flex flex-col justify-between">
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 p-10 bg-white/40 rounded-[2.5rem] border border-white/5">
            ...
            {/* MODIFICATION MODAL */}
            {editingBooking && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-white/80 backdrop-blur-md animate-in fade-in duration-500">
                    <div className="bg-white w-full max-w-xl rounded-[3rem] shadow-2xl relative border border-white/10 overflow-hidden animate-in zoom-in-95 duration-500">
                            ...
                            <form onSubmit={handleUpdate} className="space-y-8">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-white/40 border border-white/10 rounded-2xl p-4 text-sm text-white focus:border-[#0B2D72] outline-none transition-all font-bold color-scheme-dark"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white/40 border border-white/10 rounded-2xl p-4 text-sm text-white focus:border-[#0B2D72] outline-none transition-all font-bold"
                                    />
                                </div>
            ...
            {/* REVIEW MODAL */}
            {reviewingBooking && (
                <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-white/80 backdrop-blur-md animate-in fade-in duration-500">
                    <div className="bg-white w-full max-w-xl rounded-[3rem] shadow-2xl relative border border-white/10 overflow-hidden animate-in zoom-in-95 duration-500">
                        <div className="absolute top-0 left-0 w-full h-2 bg-[#0B2D72]"></div>
                        ...
                        <div className="p-16">
                            ...
                            <form onSubmit={submitReview} className="space-y-10">
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-center gap-6 py-8 bg-white/40 rounded-[2.5rem] border border-white/5">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <button 
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full bg-white/40 border border-white/10 rounded-[2rem] p-8 text-white focus:border-[#0B2D72] outline-none text-sm font-medium transition-all resize-none placeholder:text-gray-700 italic"
                                    />
                                </div>
