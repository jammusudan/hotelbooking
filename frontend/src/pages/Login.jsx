          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                required
                placeholder="Email"
                className="w-full bg-white/40 border border-white/10 p-4 rounded-xl text-white focus:border-[#0B2D72]/50 outline-none transition-all font-medium text-sm"
                value={email}
            ...
            <>
              <div className="relative py-4 relative z-10">
                ...
                <div className="relative flex justify-center text-[9px] uppercase font-black text-gray-600">
                  <span className="bg-white px-4 tracking-[0.4em]">External Links</span>
                </div>
              </div>
