      ...
      <div className="max-w-md w-full relative group">
        ...
        <div className="relative space-y-8 bg-[#85C79A] border border-white/5 p-10 md:p-14 rounded-[3rem] shadow-2xl overflow-hidden">
          ...
          <div className="text-center relative z-10">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-white/5 rounded-3xl text-white mb-8 border border-white/5 shadow-inner">
              {config.icon}
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                required
                placeholder="Email"
                className="w-full bg-[#85C79A]/40 border border-white/10 p-4 rounded-xl text-white focus:border-[#0B2D72]/50 outline-none transition-all font-medium text-sm"
                value={email}
            ...
            <button
              type="submit"
              className="w-full group relative flex items-center justify-center gap-3 py-5 bg-[#0B2D72] text-white font-black uppercase tracking-[0.4em] text-[11px] rounded-2xl hover:bg-white transition-all transform active:scale-95"
            >
            ...
            <>
              <div className="relative py-4 relative z-10">
                ...
                <div className="relative flex justify-center text-[9px] uppercase font-black text-gray-600">
                  <span className="bg-[#85C79A] px-4 tracking-[0.4em]">External Links</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 relative z-10">
                <a
                 href={`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5001/api'}/auth/google?role=${role}`}
                  className="flex items-center justify-center gap-3 border border-white/5 p-4 rounded-xl hover:bg-white/5 font-black text-[10px] uppercase tracking-widest transition-all text-white hover:text-white"
                >
                  Google
                </a>
                <a
