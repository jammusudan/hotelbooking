    ...
    <section className="relative min-h-screen bg-[#EFEBE4] flex flex-col items-center justify-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="z-20 text-center px-4 max-w-3xl mx-auto flex flex-col items-center mt-8">
        ...
        <Link 
          ...
          className="bg-[#D4AF37] text-white font-bold text-lg md:text-xl px-12 py-4 rounded-full shadow-xl shadow-gold-500/20 hover:bg-[#B5952F] hover:shadow-2xl hover:-translate-y-1 transition duration-300 mb-6"
        >
          BOOK NOW
        </Link>
