  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="relative p-2 text-gray-900 hover:text-gray-900 transition-colors bg-white/5 rounded-full border border-white/5"
      >
        <Bell size={20} />
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 w-4 h-4 bg-[#0B2D72] text-[10px] font-black text-black rounded-full flex items-center justify-center animate-pulse border border-[#85C79A]">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-4 w-80 bg-[#85C79A] border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-300">
          ...
          <div className="p-4 bg-[#85C79A]/40 text-center">
