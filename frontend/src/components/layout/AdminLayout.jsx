          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:flex relative" ref={searchRef}>
              ...
              <input 
                ...
                className="bg-[#7FB77E]/5 border border-gray-800 rounded-xl py-2 pl-10 pr-4 text-xs font-bold text-black focus:border-[#0992C2]/50 outline-none w-48 focus:w-64 transition-all"
                value={searchQuery}
                onChange={(e) => {
