    ...
    <div className="min-h-screen bg-[#0a0a0b] flex font-sans text-gray-300">
      ...
      >
        <div className="h-full flex flex-col">
          <div className="p-8 pb-12">
            ...
            <p className="text-[10px] font-bold text-gray-500 tracking-[0.3em] mt-2">MANAGEMENT PORTAL</p>
          </div>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[9px] font-bold text-gold-500 uppercase tracking-widest">Manager</p>
                </div>
              </div>
            </div>
            <button
              onClick={handleLogout}
              className="flex items-center gap-3 text-gray-500 hover:text-red-400 text-[10px] font-black uppercase tracking-widest transition-all italic"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-20 bg-[#0a0a0b]/80 backdrop-blur-md border-b border-gray-800/50 flex items-center justify-between px-8 sticky top-0 z-40">
          ...
          <div className="flex items-center gap-4">
            <button className="p-2.5 text-gray-400 hover:bg-gray-800/50 rounded-xl relative border border-gray-800/50 shadow-inner group">
            ...
            <div className="flex items-center gap-4 pl-4 border-l border-gray-800/50">
              ...
              <div className="w-10 h-10 rounded-xl bg-gray-900 border border-gray-800 flex items-center justify-center text-gold-500 shadow-inner">
