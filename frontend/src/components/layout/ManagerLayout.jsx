    ...
    <div className="min-h-screen bg-[#281C59] flex font-sans text-[#EDF7BD]">
      ...
      >
        <div className="h-full flex flex-col">
          <div className="p-8 pb-12">
            ...
            <p className="text-[10px] font-bold text-[#EDF7BD] tracking-[0.3em] mt-2">MANAGEMENT PORTAL</p>
          </div>
          ...
          <div className="p-8 border-t border-gray-800/50">
            <div className="mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-black text-[#EDF7BD]">{user?.name}</p>
                  <p className="text-[9px] font-bold text-[#EDF7BD] uppercase tracking-widest">Manager</p>
                </div>
              </div>
            </div>
            <button
              onClick={handleLogout}
              className="flex items-center gap-3 text-[#EDF7BD] hover:text-red-400 text-[10px] font-black uppercase tracking-widest transition-all italic"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-20 bg-[#281C59]/80 backdrop-blur-md border-b border-gray-800/50 flex items-center justify-between px-8 sticky top-0 z-40">
          ...
          <div className="flex items-center gap-4">
            <button className="p-2.5 text-[#EDF7BD] hover:bg-gray-800/50 rounded-xl relative border border-gray-800/50 shadow-inner group">
            ...
            <div className="flex items-center gap-4 pl-4 border-l border-gray-800/50">
              <div className="text-right hidden sm:block">
                <p className="text-xs font-black text-[#EDF7BD] uppercase tracking-tighter">Manager</p>
                <div className="h-0.5 w-full bg-[#281C59]/30 mt-0.5"></div>
              </div>
              <div className="w-10 h-10 rounded-xl bg-[#281C59] border border-gray-800 flex items-center justify-center text-[#EDF7BD] shadow-inner">
